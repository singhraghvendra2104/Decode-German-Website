...
export const theTeamContent = {
  ...
  members: [
    ...
    {
      name: "Lennart Hentschel",
      role: "Native Speaker & Language Trainer",
      description: "Helping students build real conversational confidence with an authentic German voice.",
      image: "/about/team/lennart-hentschel.webp",
    },
    {
      name: "Srishty Arora",
...
export const globalCommunityContent = {
  ...
  countries: [
    ...
    { name: "Uzbekistan", lat: 41.4, lon: 64.6 },
  ],
};
