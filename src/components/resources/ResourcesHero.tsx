...
export default function ResourcesHero() {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 mb-10 md:mb-16 items-end">
      <div className="lg:col-span-7">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-[var(--font-serif)] italic font-bold leading-[0.9] tracking-tighter mb-4 md:mb-8">
          Beyond <br />
          <span className="pl-6 md:pl-20">the Classroom.</span>
        </h1>
      ...
      <div className="lg:col-span-5 relative">
        <div className="bg-white p-3 md:p-6 shadow-lg rotate-[1.2deg] border-b-[24px] md:border-b-[40px] border-white max-w-sm mx-auto lg:max-w-none">
          <Image
            ...
            width={600}
            height={600}
            className="w-full aspect-square object-cover grayscale hover:grayscale-0 transition-all duration-700 mb-2 md:mb-4"
          />
