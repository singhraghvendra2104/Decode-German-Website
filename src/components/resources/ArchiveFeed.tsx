...
export default function ArchiveFeed({ resources, categories = [] }: Props) {
  ...
  const activeCategoryLabel =
    activeCategory === "all"
      ? "All"
      : cats.find((c) => c.value === activeCategory)?.label || activeCategory;
  ...
  return (
    <section className="mb-10 md:mb-16">
      <div className="border-b border-gray-200 pb-4 md:pb-8 mb-8 md:mb-12 flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6">
        ...
        <div className="hidden md:flex flex-wrap gap-4">
          <button
            ...
            className={`px-4 py-1 text-[11px] uppercase tracking-widest transition-colors ${
              activeCategory === "all"
        ...
        <div className="md:hidden relative" ref={dropdownRef}>
          <button
            ...
            className="w-full flex items-center justify-between px-4 py-2.5 border border-gray-200 text-[11px] uppercase tracking-widest font-semibold bg-white"
          >
          ...
          {dropdownOpen && (
            <>
              ...
              />
              <div className="absolute top-full left-0 right-0 z-20 bg-white border border-gray-200 border-t-0 shadow-lg">
                <button
                  onClick={() => handleCategoryChange("all")}
      ...
      {filtered.length > 0 ? (
        <>
          {/* Mobile: horizontal scroll row — all items */}
