...
const inputClass =
  "w-full bg-transparent border-0 border-b border-charcoal/15 focus:border-primary focus:ring-0 font-[var(--font-serif)] text-lg italic py-2 px-0 placeholder:text-charcoal/20 text-charcoal outline-none transition-colors";

const selectClass =
  "w-full bg-transparent border-0 border-b border-charcoal/15 focus:border-primary focus:ring-0 font-[var(--font-serif)] text-lg italic py-2 px-0 text-charcoal outline-none appearance-none cursor-pointer transition-colors";
    ...
    >
      <div data-lenis-prevent className="relative">
        ...
        <div className="bg-white shadow-2xl relative">
          ...
          {/* Header */}
          <div className="px-8 pt-14 pb-6 md:px-12 md:pt-16 md:pb-8 border-b border-charcoal/5">
            <p className="text-primary text-[10px] font-bold tracking-[0.3em] uppercase mb-3">
              Start Your Journey
            </p>
            <h2 className="font-[var(--font-serif)] text-3xl md:text-4xl italic font-bold text-charcoal leading-tight">
          ...
          <div
            data-lenis-prevent
            className="px-8 py-8 md:px-12 md:py-10 max-h-[55vh] overflow-y-auto"
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="bg-primary text-white px-10 md:px-12 py-4 md:py-5 text-xs uppercase tracking-[0.3em] font-bold hover:bg-charcoal transition-all duration-500 flex items-center gap-4 group cursor-pointer disabled:opacity-60"
                  >
          ...
          <div className="border-t border-charcoal/5 bg-warm-sand/50 px-8 py-5 md:px-12 border-l-4 border-l-primary">
            <div className="flex items-start gap-4">
              <svg className="w-7 h-7 text-primary shrink-0 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div>
                <h3 className="font-[var(--font-serif)] text-lg md:text-xl font-bold italic text-charcoal">
                  Want a faster reply?
                </h3>
          ...
          {/* Bottom contact info */}
          <div className="px-8 py-5 md:px-12 flex flex-wrap items-center gap-x-6 gap-y-2 text-charcoal/40">
