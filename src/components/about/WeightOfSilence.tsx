...
export default function WeightOfSilence() {
  return (
    <section className="py-40 bg-paper-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-1/3 h-full bg-warm-sand/20 -z-0" />
      <div className="max-w-[1200px] mx-auto px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          {/* Sticky Sidebar */}
          <div className="lg:col-span-4 lg:sticky lg:top-40">
            <h2 className="text-4xl font-[var(--font-serif-alt)] italic leading-tight mb-8">
            ...
            <p className="mt-8 font-[var(--font-handwriting)] text-2xl text-stone-gray/60 leading-relaxed">
          ...
          <div className="lg:col-span-7 lg:col-start-6 space-y-16">
            <div className="max-w-none">
              <p className="text-xl leading-relaxed text-charcoal drop-cap">
            ...
            <div className="relative group">
              ...
              <div className="absolute -right-8 -bottom-8 bg-paper-white p-6 border border-warm-sand shadow-lg max-w-xs">
                <p className="italic font-[var(--font-serif-alt)] text-lg leading-snug">
                  {weightOfSilence.imageQuote}
                </p>
              </div>
            </div>

            <p className="text-lg text-stone-gray leading-relaxed pt-12">
              We focus on the{" "}
