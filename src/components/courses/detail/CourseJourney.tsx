...
export default function CourseJourney({ level, blocks }: CourseJourneyProps) {
  return (
    <section id="journey" className="bg-ivory py-24 md:py-40 relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 md:px-6 relative z-10">
        {/* Header */}
        <div className="text-center mb-20 md:mb-32">
          <h2 className="font-[var(--font-serif)] text-5xl md:text-7xl lg:text-8xl italic leading-none mb-6">
            The <span className="not-italic">{level} Journey</span>
          </h2>
          <p className="text-stone-gray max-w-md mx-auto">
